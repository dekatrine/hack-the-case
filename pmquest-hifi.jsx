  ...
  const drillTopics = [
    {
      ...
      bank: {
        junior: [
          "Product sense — это про что? Одной фразой.",
          "Назови primary user приложения заметок.",
          "Одно улучшение Spotify. Какое?",
          "Что такое aha-moment? Пример.",
          "Хорошая фича vs красивая идея — в чём разница?",
          "Одна метрика успеха для фичи лайков.",
        ],
        middle: [
          "Одна боль студента в браузере — какая?",
          "Latency vs персонализация — что выберешь?",
          "Низкий D7 у медитации — одна гипотеза.",
          "MVP групповых плейлистов — что в нём?",
          "Первый сегмент для AI-календаря — кто?",
          "«Stories в банке» — за или против, одним аргументом.",
        ],
        senior: [
          "AI-ассистент в зрелом app — главный критерий «делать/нет»?",
          "Конкурент скопировал фичу — твой первый ход?",
          "Фича +engagement, −доверие. Решение?",
          "Персонализация vs прозрачность алгоритма — что важнее и почему?",
          "Продукт «слишком сложный» — первый шаг?",
          "Один product principle для детского финтеха.",
        ],
      },
    },
    {
      ...
      bank: {
        junior: [
          "Activation vs acquisition — в чём разница? Одной фразой.",
          "Назови одну vanity-метрику.",
          "Primary metric онбординга в финтехе — какая?",
          "Зачем нужен guardrail? Один пример.",
          "D1 vs D30 retention — о чём каждая?",
          "Какая метрика = «получил первую ценность»?",
        ],
        middle: [
          "NSM для маркетплейса услуг — назови.",
          "Revenue растёт, retention падает — первая проверка?",
          "Один guardrail для AI-рекомендаций.",
          "Чем мерить качество онбординга в B2B SaaS?",
          "Конверсия ↑, NPS ↓ — что это значит, одной мыслью?",
          "Верх metric tree для подписки — что?",
        ],
        senior: [
          "NSM ↑, unit-экономика ↓ — на что смотреть первым?",
          "Метрика liquidity маркетплейса в новом городе — какая?",
          "A/B поднял primary, но убил retention — решение?",
          "Сезонность vs реальный эффект — как отличить, одной идеей?",
          "Leading indicator для enterprise с длинным циклом — назови.",
          "Команда оптимизирует локальные KPI — твой первый шаг?",
        ],
      },
    },
    {
      ...
      bank: {
        junior: [
          "Activation в воронке — это что? Пример.",
          "Один способ поднять повторное использование.",
          "Referral vs paid — разница в одном предложении.",
          "Признак, что онбординг слишком длинный?",
          "Метрика качества новых пользователей — какая?",
          "Почему нельзя просто лить больше трафика?",
        ],
        middle: [
          "Activation после регистрации просел — первая проверка?",
          "Одна гипотеза роста повторных покупок.",
          "Эксперимент для referral — какой?",
          "CAC +30% — что проверишь первым?",
          "Плохой acquisition vs плохой продукт — как отличить?",
          "DAU ↑, revenue не растёт — следующий шаг?",
        ],
        senior: [
          "Growth льёт трафик, Core жалуется на качество — твой ход?",
          "Growth loop для consumer-соцсети — какой?",
          "Referral даёт юзеров с низким retention — масштабировать?",
          "Payback вырос с 6 до 15 мес — первое решение?",
          "Growth-проблема или PMF-проблема — как понять?",
          "Главная метрика квартальной программы activation — какая?",
        ],
      },
    },
    {
      ...
      bank: {
        junior: [
          "Зачем выбирать сегмент, а не «все»? Одной фразой.",
          "Один вопрос перед выходом на новый рынок.",
          "Стратегия vs roadmap — разница?",
          "Конкурентное преимущество — это что простыми словами?",
          "Когда НЕ делать фичу, даже если просят?",
          "Скорость vs качество запуска — как выбрать?",
        ],
        middle: [
          "Выход в B2B — главный вопрос перед решением?",
          "Build vs partner для AI-фичи — главный критерий?",
          "Сегмент для первого запуска — кого берёшь?",
          "Конкурент копирует фичу — твой ход?",
          "Главный trade-off premium-подписки?",
          "Запускать в новой стране — первый критерий?",
        ],
        senior: [
          "Продукт на плато — как выбрать следующий bet?",
          "Строить ли платформенную capability — главный критерий?",
          "Два прибыльных сегмента, разные продукты — как выбрать?",
          "Один moat для AI-продуктивности.",
          "Каннибализировать выручку self-serve продуктом — за/против?",
          "Where to play для B2B SaaS — назови одно.",
        ],
      },
    },
    {
      ...
      bank: {
        junior: [
          "Problem interview vs продажа идеи — разница?",
          "Один плохой вопрос для интервью юзера.",
          "Признак, что боль достаточно сильная?",
          "JTBD простыми словами — одна фраза.",
          "Почему поведение надёжнее обещаний?",
          "Problem statement для трекера привычек — одной строкой.",
        ],
        middle: [
          "Юзеры просят «уведомления» — как проверить реальную боль?",
          "Сигнал, что opportunity стоит брать в roadmap?",
          "Сегментировать по jobs, а не демографии — пример.",
          "Интервью и аналитика противоречат — твой ход?",
          "Корень Opportunity Solution Tree для activation — что?",
          "Один признак, что problem статус — гипотеза, а не факт.",
        ],
        senior: [
          "Continuous discovery в команде релизов — первый шаг?",
          "Sales давит enterprise-фичу — как не потерять фокус?",
          "Несколько opportunity, данных мало — как выбрать?",
          "Discovery-артефакт-«театр» — назови один.",
          "Research cadence для маркетплейса — как часто?",
          "Доказать lead, что нужно 2 недели discovery — главный аргумент?",
        ],
      },
    },
    {
      ...
      bank: {
        junior: [
          "Одна обязательная часть PRD.",
          "Roadmap vs список фич — разница?",
          "Признак, что фича готова к запуску?",
          "Зачем запускать поэтапно (rollout)?",
          "Один риск запуска новой функции.",
          "Зачем фиче метрика успеха? Одной фразой.",
        ],
        middle: [
          "Метрика упала после релиза — первая проверка?",
          "Главный пункт launch plan для оплаты?",
          "Баг vs техдолг vs фича — как приоритизировать, одним критерием?",
          "Один пункт pre-mortem перед релизом.",
          "Команда не успевает к дедлайну — какой trade-off?",
          "Чем синхронизировать roadmap между командами?",
        ],
        senior: [
          "Adoption низкий, feedback хороший — первая гипотеза?",
          "Enterprise sales меняет приоритеты — как держать roadmap?",
          "Reliability vs growth — как решить конфликт, одним принципом?",
          "Один launch gate для regulated финтеха.",
          "Execution-проблема или strategy-проблема — как понять?",
          "Operating cadence для 4 squads — главный ритуал?",
        ],
      },
    },
  ];
  ...
  const generateQuestions = async (nextTopic = topic) => {
    ...
    try {
      const res = await api.coach({
        ...
        stepDescription: "Сгенерируй короткие блиц-вопросы для 60-секундного PM drill.",
        ...
        answerText: "",
        userMessage: `Сгенерируй 10 коротких блиц-вопросов на тему ${nextTopic.label}, уровень ${level.label}. ЖЁСТКИЕ требования: каждый вопрос ≤ 12 слов, на него можно ответить за 60 секунд одной мыслью, списком из 2-3 пунктов или одним выбором с обоснованием. Без многосоставных «опиши сегмент, боль, решение и метрику» — максимум один фокус на вопрос. Junior = базовое определение/различие, Middle = одна проверка/выбор/гипотеза, Senior = один критерий решения или первый ход. Примеры формата: «Activation vs acquisition — разница?», «CAC +30% — что проверишь первым?», «Один guardrail для AI-рекомендаций.»`,
        chatHistory: [],
        previousAnswers: {},
        trackId: "product",
      });
