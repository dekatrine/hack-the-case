...
в четырёх полях → ИИ-разбор → редактирование и повторная проверка.
Настройки генерации: направление, отрасль, сложность и необязательный контекст.
...
ИИ-маршрут, а оценка использует четыре блока вместо большого учебного рубрикатора.
